#####################################################################
# Script from Kenneth generates qc.raw file to be used by gemma package.
# Next step will be to generate GWAS$phenotype.txt script in h_dataPrep.R,
# then run qc_gard.R to generate the input files for gemma.
#####################################################################
